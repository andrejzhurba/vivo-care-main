...
export const Route = createFileRoute("/where-to-buy")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Знайдіть найближчий магазин або замовляйте онлайн підгузки та пелюшки VIVO Care. Офіційні партнери: Капітошка, Igorek, Prom.ua. Доставка по всій Україні.",
      },
    ],
  }),
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto font-light">
              Ми співпрацюємо з провідними інтернет-магазинами та аптечними мережами України, 
              щоб ви могли отримати якісну допомогу вчасно.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="bg-white/5 border border-white/10 p-8 rounded-[2.5rem] backdrop-blur-sm text-center">
              ...
              <p className="text-slate-400 text-sm font-light leading-relaxed">Швидко та зручно через маркетплейси та спеціалізовані сайти.</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-8 rounded-[2.5rem] backdrop-blur-sm text-center">
              <div className="w-12 h-12 bg-blue-500/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-slate-400 text-sm font-light leading-relaxed">Офіційний представник у місті Київ забезпечує постійний склад.</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-8 rounded-[2.5rem] backdrop-blur-sm text-center">
              <div className="w-12 h-12 bg-blue-500/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-slate-400 text-sm font-light leading-relaxed">Надсилаємо Новою Поштою та Укрпоштою у будь-який куточок країни.</p>
            </div>
          </div>
